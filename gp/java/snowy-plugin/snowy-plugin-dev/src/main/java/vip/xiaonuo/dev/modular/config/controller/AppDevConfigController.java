...
import vip.xiaonuo.dev.modular.config.param.DevConfigAddParam;
import vip.xiaonuo.dev.modular.config.param.DevConfigBatchParam;
import vip.xiaonuo.dev.modular.config.param.DevConfigEditParam;
import vip.xiaonuo.dev.modular.config.param.DevConfigIdParam;
import vip.xiaonuo.dev.modular.config.param.DevConfigListParam;
import vip.xiaonuo.dev.modular.config.param.DevConfigPageParam;
...
@Validated
@RequestMapping("/app")
public class AppDevConfigController {
